...
![Version](https://img.shields.io/badge/version-0.5.13-green.svg?style=flat-square)
...
Fix default values on new instance. Fix clock reset issue. Change flashing blue for a more chill blue on controls. Fix root note and scale saving bug.
